...
DEFAULT_SEMI_AUTOMATED_IDS = {
    ...
    "2.3.3",  # Animation from interactions: reduced-motion check
    "2.4.3",
    "2.4.7",
    "2.4.11",
    "2.4.12",
    "2.4.13",  # Focus appearance: area + contrast measurement
...
SUCCESS_CRITERIA = [
    ...
    ("1.2.6", "Sign Language (Prerecorded)", "1.2 Time-based Media", "AAA"),
    ("1.2.7", "Extended Audio Description (Prerecorded)", "1.2 Time-based Media", "AAA"),
    ("1.2.8", "Media Alternative (Prerecorded)", "1.2 Time-based Media", "AAA"),
    ("1.2.9", "Audio-only (Live)", "1.2 Time-based Media", "AAA"),
    ...
    ("1.3.6", "Identify Purpose", "1.3 Adaptable", "AAA"),
    ...
    ("1.4.6", "Contrast (Enhanced)", "1.4 Distinguishable", "AAA"),
    ("1.4.7", "Low or No Background Audio", "1.4 Distinguishable", "AAA"),
    ("1.4.8", "Visual Presentation", "1.4 Distinguishable", "AAA"),
    ("1.4.9", "Images of Text (No Exception)", "1.4 Distinguishable", "AAA"),
    ...
    ("2.1.3", "Keyboard (No Exception)", "2.1 Keyboard Accessible", "AAA"),
    ...
    ("2.2.3", "No Timing", "2.2 Enough Time", "AAA"),
    ("2.2.4", "Interruptions", "2.2 Enough Time", "AAA"),
    ("2.2.5", "Re-authenticating", "2.2 Enough Time", "AAA"),
    ("2.2.6", "Timeouts", "2.2 Enough Time", "AAA"),
    ("2.3.1", "Three Flashes or Below Threshold", "2.3 Seizures and Physical Reactions", "A"),
    ("2.3.2", "Three Flashes", "2.3 Seizures and Physical Reactions", "AAA"),
    ("2.3.3", "Animation from Interactions", "2.3 Seizures and Physical Reactions", "AAA"),
    ...
    ("2.4.8", "Location", "2.4 Navigable", "AAA"),
    ("2.4.9", "Link Purpose (Link Only)", "2.4 Navigable", "AAA"),
    ("2.4.10", "Section Headings", "2.4 Navigable", "AAA"),
    ("2.4.11", "Focus Not Obscured (Minimum)", "2.4 Navigable", "AA"),
    ("2.4.12", "Focus Not Obscured (Enhanced)", "2.4 Navigable", "AAA"),
    ("2.4.13", "Focus Appearance", "2.4 Navigable", "AAA"),
    ...
    ("2.5.5", "Target Size (Enhanced)", "2.5 Input Modalities", "AAA"),
    ("2.5.6", "Concurrent Input Mechanisms", "2.5 Input Modalities", "AAA"),
    ...
    ("3.1.3", "Unusual Words", "3.1 Readable", "AAA"),
    ("3.1.4", "Abbreviations", "3.1 Readable", "AAA"),
    ("3.1.5", "Reading Level", "3.1 Readable", "AAA"),
    ("3.1.6", "Pronunciation", "3.1 Readable", "AAA"),
    ...
    ("3.2.5", "Change on Request", "3.2 Predictable", "AAA"),
    ...
    ("3.3.5", "Help", "3.3 Input Assistance", "AAA"),
    ("3.3.6", "Error Prevention (All)", "3.3 Input Assistance", "AAA"),
    ("3.3.7", "Redundant Entry", "3.3 Input Assistance", "A"),
    ("3.3.8", "Accessible Authentication (Minimum)", "3.3 Input Assistance", "AA"),
    ("3.3.9", "Accessible Authentication (Enhanced)", "3.3 Input Assistance", "AAA"),
...
def registry_by_id() -> Dict[str, CriterionDefinition]:
    return {row.id: row for row in build_registry()}
